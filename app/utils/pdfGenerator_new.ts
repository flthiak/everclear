      ...
      <body>
          <div class="invoice-header">
              ...
              <div class="invoice-title">
                  <div class="cash-label">${data.payment_method ? (data.payment_method === 'credit' ? 'CREDIT' : 'CASH') : 'CASH'}</div>
                  <h1>INVOICE</h1>
              </div>
          </div>
